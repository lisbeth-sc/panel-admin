            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-head-row">
                        ...
                        <div class="card-tools">
                            <a href="#" class="btn btn-primary btn-icon-only"><span
                                        class="icon flaticon-down-arrow"></span></a>
                            <a href="#" class="btn btn-primary btn-icon-only"><span
                                        class="icon flaticon-repeat"></span></a>
                            <a href="#" class="btn btn-primary btn-icon-only"><span
                                        class="icon flaticon-cross"></span></a>
                        </div>
                    </div>
                    <p class="card-category">
                    ...
                    <div class="card-head-row">
                        ...
                        <div class="card-tools">
                            <ul class="nav nav-pills nav-secondary nav-pills-no-bd nav-sm" id="pills-tab"
                                role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="pills-home" data-toggle="pill"
                                       href="#pills-home" role="tab" aria-selected="true">Today</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-profile" data-toggle="pill"
                                       href="#pills-profile" role="tab" aria-selected="false">Week</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-contact" data-toggle="pill"
        ...
        <div class="col-md-4">
            <div class="card card-round">
                <div class="card-body">
                    ...
                    <div class="card-list">
                        <div class="item-list">
                            <img src="{{asset('assets/img/jm_denis.jpg')}}" alt="denis" class="small-pic">
                        ...
                        <div class="item-list">
                            <img src="{{asset('assets/img/chadengle.jpg')}}" alt="chad" class="small-pic">
                            <div class="info-user ml-3">
                        ...
                        <div class="item-list">
                            <img src="{{asset('assets/img/mlane.jpg')}}" alt="john doe" class="small-pic">
                            <div class="info-user ml-3">
                        ...
                        <div class="item-list">
                            <img src="{{asset('assets/img/talha.jpg')}}" alt="talha" class="small-pic">
                            <div class="info-user ml-3">
                        ...
                        <div class="item-list">
                            <img src="{{asset('assets/img/sauro.jpg')}}" alt="sauro" class="small-pic">
                            <div class="info-user ml-3">
                        ...
                        <div class="item-list">
                            <img src="{{asset('assets/img/arashmil.jpg')}}" alt="arash mil" class="small-pic">
                            <div class="info-user ml-3">
